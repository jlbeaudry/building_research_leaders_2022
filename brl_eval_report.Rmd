...
table_nums(name = "career_stage", 
           caption = "We asked participants to elaborate on whether they thought the workshop was appropriate for their career stage.")

table_nums(name = "info_workshop", 
           caption = "We asked participants what they expected from this workshop.")

table_nums(name = "expectations", 
           caption = "We asked participants to elaborate on how the workshop aligned with their expectations.")

table_nums(name = "action", 
          caption = "We asked participants to explain whether this workshop inspired them to take any immediate action(s).")

table_nums(name = "success",
             caption = "We asked participants if they credited any research successes to the workshop.")

table_nums(name = "best_parts",
             caption = "We asked participants to explain the best parts of the workshop.")

table_nums(name = "improvement",
             caption = "We asked participants for any suggestions for improvement.")

table_nums(name = "anything_else",
             caption = "We asked participants if there was anything else they wanted us to know.")
...
At the time of this evaluation, we had offered 5 of the 6 sessions that comprised
the 2022 offering of the *Building Research Leaders for Early Career Researchers* workshop. 
...
kable(
  ...
  align = c('cl'),
  linesep = "\\addlinespace",
  caption = "We asked participants to explain what they expected from the workshop.",
...
kable(
  ...
  align = c('cl'),
  linesep = "\\addlinespace",
  caption = "We asked participants to provide suggestions for improvement.",
  col.names = c("Participant", "Response")
  ) %>%
  column_spec (column = 2, width = "14cm") %>%
  kable_styling(latex_options = c("HOLD_position"))
...
kable(
  ...
  align = c('cl'),
  linesep = "\\addlinespace",
  caption = "We asked participants whether they had anything else they wanted us to know.",
  col.names = c("Participant", "Response")
  ) %>%
  column_spec (column = 2, width = "14cm") %>%
  kable_styling(latex_options = c("HOLD_position"))
